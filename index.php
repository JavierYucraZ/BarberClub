...
<html lang="es">
  <head>
    <title>
      The ClassicClub BarberShop | Bienvenido
    </title>
    <!-- for-mobile-apps -->
    ...
    <meta
      name="keywords"
      content="Hair Salon Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design"
    ...
    <!--/web-fonts-->
    <link
      href="//fonts.googleapis.com/css?family=Playfair+Display:400,400i,700,700i,900"
      rel="stylesheet"
    />
    <link
      href="//fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i"
      rel="stylesheet"
    />
    <!--//web-fonts-->
    <link rel="shortcut icon" href="./images/logobarber.jpeg" type="image/x-icon">
  </head>
  <body>
    <!--/main-header-->
    <!--/banner-section-->
    <div
      id="demo-1"
      data-zs-src='["images/img4.jpg", "images/img2.jpg", "images/img6.jpg"]'
      data-zs-overlay="dots"
    >
      <?php include_once("./shared/navbar.html") ?>
    </div>
    <!--/banner-section-->
    <!-- /about -->
      ...
      <div class="container">
        <div class="ab-w3l-spa">
          <div class="title-agileits">
            <h2 class="w3l-agile">Bienvenido a The ClassicClub BarberShop</h2>
          </div>
          ...
          <img src="images/img4.jpg" class="img-responsive" alt="Hair Salon" />
          <!--Slider-->
          <div class="slider-agileits-ab">
            ...
            <div class="w3ls-info-about">
              <h4>Vive una experiencia única y relajante</h4>
    ...
    <div class="w3l-services-agile">
      <div class="container">
        <div class="title-agileits">
          <h3 class="w3l-agile">Nuestros Servicios</h3>
        </div>
      </div>
            ...
            <ul class="slides">
              ...
              <li>
                ...
                <div class="w3layouts_work_grid_right">
                  ...
                  <p>
                    Duis vitae faucibus quam. Sed tempus vestibulum lacus
                    blandit faucibus. Nunc imperdiet, diam nec rhoncus
    ...
    <div class="price" id="price">
      <div class="col-md-6 w3l_about_bottom_right">
        ...
        <p>
          Lorem magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
      ...
      <div class="col-md-6 w3l_about_bottom_left"></div>
            ...
            <div class="col-md-6 w3-agile-blog-right">
              <div class="w3-agile-blog-right-top">
                ...
                <div class="blog-left-right-top">
                  <h4>
                    <a href="single.html"> In hac habitasse platea dictumst.</a>
                  </h4>
                  <p>
                    Posted By <a href="#">Admin</a> on Dec 2, 2016
              ...
              <div class="w3-agile-blog-right-info">
                <p>
                  Nullam in dui dolor. Donec faucibus, est sed mattis placerat,
                  lorem orci vestibulum lorem, vel accumsan nisl urna eget leo.
                  Cras varius bibendum augue nec pretium. Aenean a ex ante. Nunc
                  ut dignissim justo, ut commodo odio. Donec magna mi, accumsan
                  a mi eu, fermentum tempus elit.
                </p>
                <a href="single.html" class="hvr-shutter-in-horizontal"
                  >Read More</a
                >
              </div>
            </div>
            ...
            <li class="mis-slide">
              ...
              <a href="#" class="mis-container">
                ...
                <figure>
                  ...
                  <figcaption>
                    Carl Lii<span
                      >Sed maximus eros quis leo congue ipsum sagittis.</span
                    >
                  </figcaption>
                </figure>
              </a>
    ...
    <div id="small-dialog1" class="mfp-hide">
      <iframe
        src="https://player.vimeo.com/video/36382067"
        frameborder="0"
      ></iframe>
    </div>
